...
//
// The Registry is used to collect all the files data, aggregate the objects and
// output the new files.
// It works as follow:
//  - parse the sys package only selecting the files we are interested in
//    TODO make it compatible with consolidated files.
...
//  - remove the consolidated objects from each GOOS/GOARCH file
